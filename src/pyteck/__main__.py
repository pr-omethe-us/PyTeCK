...
def main():
    ...
    parser.add_argument(
        "-m", "--model", type=str, required=True, help="Input model filename (e.g., mech.yaml)."
    )
    parser.add_argument(
        "-k",
        "--model-keys",
    ...
    parser.add_argument(
        "-d", "--dataset", type=str, required=True, help="Filename for list of datasets."
    )
    parser.add_argument(
        "-dp",
        "--data-path",
    ...
    parser.add_argument(
        ...
        required=False,
        help="YAML with variants for models for, e.g., bath gases and pressures.",
    )
    parser.add_argument(
        "-nt",
        "--num-threads",
        ...
        required=False,
        help="The number of threads to use to run simulations in parallel.",
    )
    parser.add_argument(
        "-p",
        "--print",
