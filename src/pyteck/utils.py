...
get_temp_unit = {"K": "kelvin", "C": "degC", "F": "degF", "R": "degR"}


# Unique InChI identifier for species
SPEC_KEY = {
    "1S/C7H16/c1-3-5-7-6-4-2/h3-7H2,1-2H3": "nC7H16",
...
SPEC_KEY_REV = {
    "nC7H16": "1S/C7H16/c1-3-5-7-6-4-2/h3-7H2,1-2H3",
...
def print_species_names():
    ...
    for spec in SPEC_KEY_REV.items():
        print("{:<{}s} {:10}\t{}".format(SPEC_NAMES[spec[0]], len_longest, spec[0], spec[1]))
